...
const OPTIONS: AttendanceOption[] = [
  { id: '1', title: 'Attendance', icon: 'calendar-outline' },
  ...
  { id: '6', title: 'Attendance Correction', icon: 'build-outline' },
  { id: '7', title: 'My Outdoor Duty', icon: 'walk-outline' },
  { id: '8', title: 'My Work From Home', icon: 'laptop-outline' },
